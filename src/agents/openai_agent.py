...
def create_openai_agent(name: str = "openai", config: Dict[str, Any] = None) -> OpenAIAgent:
    """
    Utility function to create an OpenAI agent with configuration.
    ...
    return OpenAIAgent(name, llm_config)