...
def create_perplexity_agent(name: str = "perplexity", config: Dict[str, Any] = None) -> PerplexityAgent:
    """
    Utility function to create a Perplexity agent with configuration.
    
    Args:
        name: Name for the agent
        config: Configuration dictionary containing api_key, model, etc.
    ...
    return PerplexityAgent(name, llm_config)